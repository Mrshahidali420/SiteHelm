...
[![Operations](https://img.shields.io/badge/operations-51-blueviolet.svg)](docs/OPERATIONS.md)
...
| **Surface** | 200+ loosely specified tools | 54 operations behind 11 dispatchers, each with a strict JSON Schema |
...
54 operations across seven modules, reached through 11 MCP tools (dispatchers). Call any dispatcher with no `operation` argument to get its catalogue — agents discover the surface at runtime instead of memorising it.

<table>
<tr><th align="left">Dispatcher</th><th align="left">Operations</th></tr>
<tr><td><code>content-read</code></td><td>Posts, pages, custom post types, and taxonomies</td></tr>
<tr><td><code>content-write</code></td><td>Create, update, set status, set featured image, assign terms, update meta, trash, roll back</td></tr>
