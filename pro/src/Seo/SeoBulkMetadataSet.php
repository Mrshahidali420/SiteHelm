<?php
/**
 * REQ-0098 (Pro): set the same SEO metadata on many posts at once.
 *
 * @package SiteHelmPro
 */
...
final class SeoBulkMetadataSet implements WriteOperation {
	...
	public static function definition(): OperationDefinition {
		return new OperationDefinition(
			...
			mode: Mode::Write,
			description: 'Set the same search-engine metadata on up to fifty posts in one previewed, reversible change — title, description, canonical, focus keyword, noindex, nofollow and the social overrides — in whichever supported SEO plugin this site runs. SiteHelm Pro.',
			inputSchema: [
				'type'                 => 'object',
