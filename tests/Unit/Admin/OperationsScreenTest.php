...
final class OperationsScreenTest extends TestCase {
	...
	public function testWithoutTheAddOnEveryProOperationIsListedLockedInItsOwnGroup(): void {
		...
		$this->assertStringContainsString( '49 more with SiteHelm Pro', $html );
		$this->assertStringContainsString( '49 operations come with SiteHelm Pro.', $html );
		...
		$this->assertSame( 49, substr_count( $html, 'sitehelm-tool--locked' ) );
	...
	public function testAnInstalledButUnlicensedAddOnIsSaidSoOnceAndKeepsItsSwitches(): void {
		...
		$this->assertStringContainsString( 'value="seo-settings-get" checked', $html );
		$this->assertStringContainsString( '48 more with SiteHelm Pro', $html );
		$this->assertSame( 48, substr_count( $html, 'sitehelm-tool--locked' ) );
	}
