...
final class OperationsScreenTest extends TestCase {
	...
	public function testWithoutTheAddOnEveryProOperationIsListedLockedInItsOwnGroup(): void {
		...
		$this->assertStringContainsString( '8 more with SiteHelm Pro', $html );
		$this->assertStringContainsString( '8 operations come with SiteHelm Pro.', $html );
		...
		$this->assertSame( 8, substr_count( $html, 'sitehelm-tool--locked' ) );
	...
	public function testAnInstalledButUnlicensedAddOnIsSaidSoOnceAndKeepsItsSwitches(): void {
		...
		$this->assertStringContainsString( 'value="seo-settings-get" checked', $html );
		$this->assertStringContainsString( '7 more with SiteHelm Pro', $html );
		$this->assertSame( 7, substr_count( $html, 'sitehelm-tool--locked' ) );
	}
