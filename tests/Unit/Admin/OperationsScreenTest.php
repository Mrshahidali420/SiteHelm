...
final class OperationsScreenTest extends TestCase {
	...
	public function testWithoutTheAddOnEveryProOperationIsListedLockedInItsOwnGroup(): void {
		...
		$this->assertStringContainsString( '53 more with SiteHelm Pro', $html );
		$this->assertStringContainsString( '53 operations come with SiteHelm Pro.', $html );
		...
		$this->assertSame( 53, substr_count( $html, 'sitehelm-tool--locked' ) );
	...
	public function testAnInstalledButUnlicensedAddOnIsSaidSoOnceAndKeepsItsSwitches(): void {
		...
		$this->assertStringContainsString( 'value="seo-settings-get" checked', $html );
		$this->assertStringContainsString( '52 more with SiteHelm Pro', $html );
		$this->assertSame( 52, substr_count( $html, 'sitehelm-tool--locked' ) );
	}
