...
final class OperationsScreenTest extends TestCase {
	...
	public function testWithoutTheAddOnEveryProOperationIsListedLockedInItsOwnGroup(): void {
		...
		$this->assertStringContainsString( '16 more with SiteHelm Pro', $html );
		$this->assertStringContainsString( '16 operations come with SiteHelm Pro.', $html );
		...
		$this->assertSame( 16, substr_count( $html, 'sitehelm-tool--locked' ) );
	...
	public function testAnInstalledButUnlicensedAddOnIsSaidSoOnceAndKeepsItsSwitches(): void {
		...
		$this->assertStringContainsString( 'value="seo-settings-get" checked', $html );
		$this->assertStringContainsString( '15 more with SiteHelm Pro', $html );
		$this->assertSame( 15, substr_count( $html, 'sitehelm-tool--locked' ) );
	}
