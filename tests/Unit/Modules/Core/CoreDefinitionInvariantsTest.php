...
final class CoreDefinitionInvariantsTest extends TestCase {
	 ...
	 */
	private const CORE_WRITE_COUNT = 7;
	...
	public function test_every_write_declares_the_shared_output_schema_rather_than_an_inlined_copy(): void {
		...
		$this->assertCount(
			...
			$writes,
			'The core module must expose seven writes; an eighth write has to declare the shared union too, and this count is what makes it say so.'
		);
