...
final class CoreDefinitionInvariantsTest extends TestCase {
	 ...
	 */
	private const CORE_WRITE_COUNT = 6;
	...
	public function test_every_write_declares_the_shared_output_schema_rather_than_an_inlined_copy(): void {
		...
		$this->assertCount(
			...
			$writes,
			'The core module must expose six writes; a seventh write has to declare the shared union too, and this count is what makes it say so.'
		);
