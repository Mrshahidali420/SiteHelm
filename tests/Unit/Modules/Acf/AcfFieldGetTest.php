	...
	public function test_an_allow_list_member_matching_nothing_refuses_and_names_it(): void {
		...
		try {
			...
			$this->assertStringContainsString(
				'"subtitel"',
				$e->getMessage(),
				'The echoed member is DELIMITED. Undelimited, a member ending in a full stop reads as a continuation of our own sentence, and nothing tells a reader where our text stops and the caller\'s begins.'
			);
			$this->assertNotNull( $e->remediation );
		}
	}
